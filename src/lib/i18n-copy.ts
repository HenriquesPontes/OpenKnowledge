...
const en = {
  ...
  apiAuth: {
    ...
    turnstileLabel: "Let us know you are human",
  ...
  apiDashboard: {
    ...
    navReference: "API reference",
    backToSite: "Back to Open Knowledge",
    accessLabel: "Public GET",
    monitorBody:
      "Manage keys and send live requests to the Linguistic Research API. Public GET still works without a key.",
    account: "Account",
    apiKey: "API key",
    lexicons: "Isolated lexicons",
    origin: "API origin",
    live: "Live",
    ...
    publicGetTitle: "Public GET",
    publicGetBody:
      "Read access works without a key. A key identifies your client.",
    quickStart: "Quick start",
    quickStartBody:
      "Create a key, then send it as Authorization: Bearer. Keys are shown once.",
    reviewDocs: "Review the API reference",
    isolatedHeading: "Isolated lexicons",
    isolatedBody:
      "Each path is one dataset. Search never crosses lexicons.",
    authTitle: "Authentication",
    authBody:
      "Send Authorization: Bearer <key> or X-Api-Key: <key>. Keys use the fv_live_ prefix.",
    docsCard: "Documentation",
    docsCardBody: "Full contract, isolation rules, and OpenAPI.",
    originTitle: "Linguistic Research API",
    openPlayground: "Open playground",
    support: "Support",
    copied: "Copied",
    copy: "Copy",
    defaultKey: "Default",
    noKeysTitle: "No API key yet",
    noKeysBody:
      "Public GET works without a key. Issue one when you need to identify this client.",
    playgroundBody:
      "Send a live GET through this site to one isolated dataset on the Linguistic Research API.",
    searchPlaceholder: "Search lexicons…",
    searchAria: "Search isolated lexicons",
    attestedEntries: "Attested entries",
    families: "Countries",
    refresh: "Refresh",
    lastChecked: "Checked",
    ...
    entries: "Entries",
    family: "Country",
    allFamilies: "All countries",
    noResults: "No lexicons match that search.",
    navLexicons: "Lexicons",
    navSettings: "Settings",
    copyOrigin: "Copy origin",
    entriesByFamily: "Attested entries by country",
    lexiconsByFamily: "Isolated lexicons by country",
    topLexicons: "Largest lexicons",
    distributionHint:
      "Counts come from the live Linguistic Research catalog. Search never crosses datasets.",
    openapi: "OpenAPI",
    ...
    catalog: "Catalog",
    access: "Access",
    indexDataset: "Country index",
    variety: "Isolated lexicon",
    tryThis: "Try",
    published: "Published",
    identity: "Service",
    noEntryCount: "Not reported",
  },
  apiExplorer: {
    tryApi: "Try the API",
    headword: "Headword",
    ...
    exampleHit: "Hit — kume",
    exampleMissing: "Missing — zzznomatch",
    termNotFoundTitle: "TERM_NOT_FOUND",
    termNotFoundBody:
      "No matching headword in this isolated dataset. That is honest absence, not a soft miss or an invented gloss. Try another headword, or another lexicon — search never crosses datasets.",
    httpOk: "OK",
    httpError: "Error",
  },
  docsShell: {
...
const pt: SiteCopy = {
  ...
  apiAuth: {
    ...
    turnstileLabel: "Confirme que é humano",
  ...
  apiDashboard: {
    ...
    navKeys: "Chaves de API",
    navPlayground: "Playground",
    navDocs: "Documentação",
    navQuickstart: "Início rápido",
    navReference: "Referência da API",
    backToSite: "Voltar ao Open Knowledge",
    accessLabel: "GET público",
    monitorBody:
      "Faça a gestão das chaves e envie pedidos ao vivo para a Linguistic Research API. O GET público continua a funcionar sem chave.",
    account: "Conta",
    apiKey: "Chave de API",
    lexicons: "Léxicos isolados",
    origin: "Origem da API",
    live: "Activa",
    unreachable: "Indisponível",
    checkingApi: "A verificar…",
    noKeyYet: "Não emitida",
    keyActive: "Activa",
    prefixLabel: "Prefixo",
    memberSince: "Conta criada",
    publicGetTitle: "GET público",
    publicGetBody:
      "O acesso de leitura funciona sem chave. Uma chave identifica o seu cliente.",
    quickStart: "Início rápido",
    quickStartBody:
      "Crie uma chave e envie-a como Authorization: Bearer. As chaves são mostradas uma vez.",
    reviewDocs: "Consultar a referência da API",
    isolatedHeading: "Léxicos isolados",
    isolatedBody:
      "Cada caminho é um conjunto de dados. A pesquisa nunca cruza léxicos.",
    authTitle: "Autenticação",
    authBody:
      "Envie Authorization: Bearer <key> ou X-Api-Key: <key>. As chaves usam o prefixo fv_live_.",
    docsCard: "Documentação",
    docsCardBody: "Contrato completo, regras de isolamento e OpenAPI.",
    originTitle: "Linguistic Research API",
    openPlayground: "Abrir o playground",
    support: "Suporte",
    copied: "Copiada",
    copy: "Copiar",
    defaultKey: "Predefinida",
    noKeysTitle: "Ainda sem chave de API",
    noKeysBody:
      "O GET público funciona sem chave. Emita uma quando precisar de identificar este cliente.",
    playgroundBody:
      "Envie um GET ao vivo através deste site para um conjunto de dados isolado na Linguistic Research API.",
    searchPlaceholder: "Pesquisar léxicos…",
    searchAria: "Pesquisar léxicos isolados",
    attestedEntries: "Entradas atestadas",
    families: "Países",
    refresh: "Actualizar",
    ...
    entries: "Entradas",
    family: "País",
    allFamilies: "Todos os países",
    noResults: "Nenhum léxico corresponde a essa pesquisa.",
    navLexicons: "Léxicos",
    navSettings: "Definições",
    copyOrigin: "Copiar origem",
    entriesByFamily: "Entradas atestadas por país",
    lexiconsByFamily: "Léxicos isolados por país",
    topLexicons: "Maiores léxicos",
    distributionHint:
      "As contagens vêm do catálogo ao vivo da Linguistic Research. A pesquisa nunca cruza conjuntos de dados.",
    openapi: "OpenAPI",
    ...
    catalog: "Catálogo",
    access: "Acesso",
    indexDataset: "Índice do país",
    variety: "Léxico isolado",
    tryThis: "Experimentar",
    published: "Publicados",
    identity: "Serviço",
    noEntryCount: "Não indicado",
  },
  apiExplorer: {
    tryApi: "Experimentar a API",
    headword: "Entrada",
    ...
    exampleHit: "Existe — kume",
    exampleMissing: "Não existe — zzznomatch",
    termNotFoundTitle: "TERM_NOT_FOUND",
    termNotFoundBody:
      "Não há entrada correspondente neste conjunto de dados isolado. Isso é ausência honesta, não um erro suave nem um glossário inventado. Experimente outra entrada, ou outro léxico — a pesquisa nunca cruza conjuntos de dados.",
    httpOk: "OK",
    httpError: "Erro",
  },
  docsShell: {
